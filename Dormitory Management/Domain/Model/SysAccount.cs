...
public partial class SysAccount
{
    ...
    public virtual ICollection<AccRoomRequest> AccRoomRequestAppliedByNavigations { get; set; } =
        new List<AccRoomRequest>();

    public virtual ICollection<AccRoomRequest> AccRoomRequestStatusChangedByNavigations { get; set; } =
        new List<AccRoomRequest>();
    ...
    public virtual ICollection<TkIssueTicket> TkIssueTicketApprovedByNavigations { get; set; } =
        new List<TkIssueTicket>();

    public virtual ICollection<TkIssueTicket> TkIssueTicketCreatedByNavigations { get; set; } =
        new List<TkIssueTicket>();
